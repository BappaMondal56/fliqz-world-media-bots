...
def dynamic_update(payload: dict, animal_detected=False, das_detected=False, minor_detected=False, personal_info_detected=False):
    """
    ...
    try:
        ...
        if existing:
            ...
            if "is_nsfw" in table.c:
                update_data["is_nsfw"] = 1 if das_detected else 0
