...
def is_minor_video(video_path, frame_skip=15, min_percent=0.05, min_frames=3):
    """
    Percentage-based minor detection for video.

    frame_skip=15      → ~2 frames/sec (30fps video)
    min_percent=0.05   → 5% of checked frames
    min_frames=2       → at least 2 frames must confirm minor
    """
    ...
    return minor_frames >= min_frames and percent >= min_percent
