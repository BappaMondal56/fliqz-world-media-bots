...
def is_weapon_in_video(detections, min_conf=0.30, min_frames_required=3):
    ...
    return True if valid_count >= min_frames_required else False
...
def is_weapon_detected(path):
    ...
    if ext in image_exts:
        ...
        print("Image result:", "WEAPON DETECTED" if result else "SAFE (no weapon)")
        return result
        ...
        print("Video result:", "WEAPON DETECTED" if result else "SAFE (no weapon)")
        return result
