    ...
    def predict(self, image_path, threshold=0.8):
        ...
        try:
            ...
            is_nsfw = (
                ...
                (percentages["sexy"] > 85 and features['skin_ratio'] > 0.65)
            )
...
def is_nsfw_image(image_path, threshold=0.8):
    detector = NSFWDetector()
    result = detector.predict(image_path, threshold)
    return bool(result.get("is_nsfw", False))
